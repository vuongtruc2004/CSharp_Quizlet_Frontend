...
import AlphabetTab from "@/features/alphabet-page/ui/alphabet.tab";
  ...
  return (
    <>
      <div className="ml-27">
        ...
        <p>
          Hiragana và Katakana là chữ biểu âm, mỗi chữ thể hiện 1 âm, còn chữ
          Hán là chữ biểu ý, mỗi chữ có ý nghĩa nhất định.
        </p>
      </div>
