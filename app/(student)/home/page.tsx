...
const HomePage = () => {
    ...
    const books: IBook[] = [
        ...
        { id: 3, title: "English Grammar in Use", author: "Kuruyami259", edition: 1, image: "https://assets.quizlet.com/explanations/textbook_covers/cache/76/44/7644dbd818f90aa275c11071b74fe91e.jpid: 1" },
        ...
        { id: 7, title: "English Grammar in Use", author: "Kuruyami259", edition: 1, image: "https://assets.quizlet.com/explanations/textbook_covers/cache/76/44/7644dbd818f90aa275c11071b74fe91e.jpid: 1" },
    ...
    return (
        <Home courses={courses} books={books} authors={authors} />
    );
};
